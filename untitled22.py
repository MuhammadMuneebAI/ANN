...
Original file is located at
    https://colab.research.google.com/drive/1tCSz_H5NDiTGnyfYlRh8-CVlHId04piF
"""
...
st.sidebar.header("Parkinson’s Disease Detection dataset.csv")
...
if uploaded_file is not None:
    ...
    st.info("Please upload a CSV file with a 'status' column.")